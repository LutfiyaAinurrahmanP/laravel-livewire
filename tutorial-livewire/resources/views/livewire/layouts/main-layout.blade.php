                        ...
                        <div class="mb-5">
                            ...
                            @error('name')
                                <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                                    role="alert">
                                    <span class="font-medium">Nama tidak boleh mengandung angka maupun simbol</span>
                                </div>
                            @enderror
                                ...
                                <div class="grid grid-cols-3 gap-4 mb-4">
                                    ...
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70"
                                            viewBox="0 0 128 128">
                                            <defs>
                                                <path id="deviconLivewireWordmark0" fill="#fb70a9" fill-rule="evenodd"
                                                    d="M98.262 63.816c-1.489 2.235-2.617 4.985-5.64 4.985c-5.095 0-5.368-7.793-10.466-7.793c-5.094 0-4.816 7.793-9.91 7.793c-5.09 0-5.363-7.793-10.46-7.793c-5.095 0-4.817 7.793-9.911 7.793c-5.09 0-5.367-7.793-10.46-7.793c-5.095 0-4.817 7.793-9.911 7.793c-1.598 0-2.723-.77-3.672-1.824c-3.645-6.293-5.738-13.672-5.738-21.555c0-23.086 17.965-41.8 40.125-41.8c22.164 0 40.129 18.714 40.129 41.8c0 6.601-1.47 12.844-4.086 18.394Zm0 0" />
                                            </defs>
                                            <defs>
                                                <clipPath id="deviconLivewireWordmark1">
                                                    <path d="M0 96.48h127V128H0Zm0 0" />
                                                </clipPath>
                                            </defs>
                                            <g clip-path="url(#deviconLivewireWordmark1)">
                                                <path fill="#4e56a6" fill-rule="evenodd"
                                            ...
                                            <use href="#deviconLivewireWordmark0" fill-rule="evenodd" />
                                            <path fill="#4e56a6" fill-rule="evenodd"
                                            ...
                                            <path fill-opacity=".298" fill-rule="evenodd"
                                                d="M46.195 64.996c-1.004-1.223-2.195-2.129-3.914-2.129c-4.086 0-4.836 5.113-7.418 7.418V48.23c0-3.105 2.535-5.625 5.664-5.625c3.133 0 5.668 2.52 5.668 5.625Zm21.41.395c-1.07-1.418-2.324-2.524-4.226-2.524c-4.547 0-4.965 6.328-8.367 8.078v-9.754c0-3.453 2.82-6.25 6.297-6.25c3.48 0 6.296 2.797 6.296 6.25Zm20.153-1.094c-.875-.856-1.906-1.43-3.281-1.43c-4.403 0-4.934 5.938-8.055 7.899V50.973c0-3.106 2.539-5.625 5.668-5.625s5.668 2.52 5.668 5.625Zm0 0" />
                                            <use href="#deviconLivewireWordmark0" fill-rule="evenodd" />
                                            <path fill="#e24ca6" fill-rule="evenodd"
                                                d="M89.578 67.969c10.516-15.528 10.79-32.754.817-51.672c7.39 7.515 11.953 17.832 11.953 29.21a41.526 41.526 0 0 1-4.235 18.329c-1.543 2.223-2.715 4.965-5.847 4.965a4.624 4.624 0 0 1-2.688-.832Zm0 0" />
                                            <path fill="#fff" fill-rule="evenodd"
                                                d="M60.07 55.848c13.953 0 19.828-8.035 19.828-19.446c0-11.414-8.878-21.918-19.828-21.918c-10.953 0-19.832 10.504-19.832 21.918c0 11.41 5.875 19.446 19.832 19.446Zm0 0" />
                                            <path fill="#030776" fill-rule="evenodd"
                                                d="M62.176 28.898c0 4.5-3.332 8.145-7.438 8.145c-4.105 0-7.437-3.645-7.437-8.145s3.332-8.148 7.437-8.148c4.106 0 7.438 3.648 7.438 8.148Zm0 0" />
                                            <path fill="#fff" fill-rule="evenodd"
                                                d="M57.215 27.02c0 2.074-1.664 3.757-3.715 3.757c-2.055 0-3.719-1.683-3.719-3.757c0-2.079 1.664-3.762 3.719-3.762c2.05 0 3.715 1.683 3.715 3.762Zm0 0" />
                                        </svg>
                                    </div>
                                    <div
                                        class="flex items-center justify-center h-24 rounded-sm bg-gray-50 dark:bg-gray-800">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="#3B82F6" />
                                            <path
                                                d="M15.5 11H13V8.5C13 7.67 12.33 7 11.5 7C10.67 7 10 7.67 10 8.5V11H7.5C6.67 11 6 11.67 6 12.5C6 13.33 6.67 14 7.5 14H10V16.5C10 17.33 10.67 18 11.5 18C12.33 18 13 17.33 13 16.5V14H15.5C16.33 14 17 13.33 17 12.5C17 11.67 16.33 11 15.5 11Z"
                                                fill="#3B82F6" />
                                        </svg>
                                        <img src="{{ asset('flowbite-logo.png') }}" alt="Logo">
