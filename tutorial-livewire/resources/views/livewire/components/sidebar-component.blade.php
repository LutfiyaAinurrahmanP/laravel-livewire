            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="form"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Event Form</span>
                    </a>
                </li>
                <li>
                    <a href="action"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Action Variable</span>
                    </a>
                </li>
                <li>
                    <a href="crud"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">CRUD DB</span>
                    </a>
                </li>
                <li>
                    <a href="logout"
